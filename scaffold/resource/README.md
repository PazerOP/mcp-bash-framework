...
- `__NAME__.meta.json` registers the resource; the framework infers the `file://` URI from the file location during discovery to stay portable when the project moves.
