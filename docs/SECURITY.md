...
- Tools/resources inherit the server environment; operators should constrain roots (`MCP_RESOURCES_ROOTS`) and environment variables when running untrusted scripts (Spec §13, §14).
